...
namespace Client.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(ILogger<HomeController> logger, INationalParkRepository nationalParkRepository, ITrailRepository trailRepository, IAccountRepository accRepo)
        {
            _logger = logger;
        ...
        {
            // showing national parks and trails
        ...
        public async Task<IActionResult> Login(User obj)
        {
            ...
            // add alert temporary with username
